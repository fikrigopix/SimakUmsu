...
(function ($, undefined) {
    ...
    $.fn.select2.defaults = {
        ...
        formatNoMatches: function () { return "Tidak ditemukan data.."; },
        formatInputTooShort: function (input, min) { var n = min - input.length; return "Masukkan " + n + " karakter lagi" + (n == 1 ? "" : "s"); },
        formatInputTooLong: function (input, max) { var n = input.length - max; return "Hapus " + n + " karakter" + (n == 1 ? "" : "s"); },
        formatSelectionTooBig: function (limit) { return "Hanya dapat milih " + limit + " item" + (limit == 1 ? "" : "s"); },
        formatLoadMore: function (pageNumber) { return "Memuat data..."; },
        formatSearching: function () { return "Cari..."; },
