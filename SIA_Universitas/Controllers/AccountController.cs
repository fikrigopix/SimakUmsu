...
namespace SIA_Universitas.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [ValidateAntiForgeryToken]
        [HttpPost]
        public ActionResult RegisterUser(string loginname, string passwordtext, string rolename)
        {
            var context = new SIA_Universitas.Models.ApplicationDbContext();
            IdentityResult ir;
            ...
            ir = um.Create(user, passwordtext);
    ...
    //        }
    //        if (email == "adminprodi@umsu.ac.id" && password == "admin@pass")
    //        {
    //            Response.Cookies["user"].Value = "AdminProdi";
    //            Response.Cookies["user"].Expires = DateTime.Now.AddHours(1);
    //        }
    //        return RedirectToAction("index","Home");
    //    }
